...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELPAPP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HELPAPPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HELPAPP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELPAPP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELPAPP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELPAPP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELPAPP actions', async () => {
      const expectedActions = [
        {
