...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CONTACTUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CONTACTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTUS actions', async () => {
      const expectedActions = [
        {
