...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATICPAGE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STATICPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STATICPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATICPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATICPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATICPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATICPAGE actions', async () => {
      const expectedActions = [
        {
